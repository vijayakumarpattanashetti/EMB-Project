...
export default {
  ...
  entry: {
    ...
    'vendor': [...hotReloadModules, resolve(__dirname, 'src/vendor/index')],
    'government': [...hotReloadModules, resolve(__dirname, 'src/government/index')],
    'hospital': [...hotReloadModules, resolve(__dirname, 'src/hospital/index')],
